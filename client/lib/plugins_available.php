<?php
  ...
  function createDefaultPluginList(){
    ...
    $plugins[] = new AbstractPlugin( "echoBack", array("clientDir"=>"") );
    
    // default client plugins
    $plugins[] = new AbstractPlugin( "home", array("serverDir"=>"") );
    $plugins[] = new AbstractPlugin( "plugins", array("serverDir"=>"") );
    $plugins[] = new AbstractPlugin( "about", array("serverDir"=>"") );
  ...
  function saveAvailablePluginsToConfig( $plugins ){
    ...
    foreach ($plugins as $plugin){
      ...
      $data[$name] = array( "serverDir"=>$serverDir, "clientDir"=>$clientDir, "version"=>$version, "active"=>$active );
    }
